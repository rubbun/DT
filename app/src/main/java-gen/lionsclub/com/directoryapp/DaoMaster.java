...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(CredentialRequestQueueDao.class);
    }
    
    /** Creates underlying database table using DAOs. */
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        DistrictDao.createTable(db, ifNotExists);
        ClubDao.createTable(db, ifNotExists);
        MemberDao.createTable(db, ifNotExists);
        CredentialRequestQueueDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        DistrictDao.dropTable(db, ifExists);
        ClubDao.dropTable(db, ifExists);
        MemberDao.dropTable(db, ifExists);
        CredentialRequestQueueDao.dropTable(db, ifExists);
    }
